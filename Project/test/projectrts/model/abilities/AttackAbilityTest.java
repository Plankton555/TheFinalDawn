...
public class AttackAbilityTest {
	...
	public void test() {
		...
		EntityManager.INSTANCE.addNewPCE(Warrior.class.getSimpleName(), player1,warriorSpawnPos);
		EntityManager.INSTANCE.addNewPCE(Worker.class.getSimpleName(), player2,workerSpawnPos);
		EntityManager.INSTANCE.update(1);
		
		Warrior warrior = (Warrior) EntityManager.INSTANCE.getPCEAtPosition(warriorSpawnPos);
		Worker worker = (Worker) EntityManager.INSTANCE.getPCEAtPosition(workerSpawnPos);
