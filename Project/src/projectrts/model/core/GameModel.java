...
public class GameModel implements IGame {
	...
	public GameModel() {
		...
		entityManager.addNewPCE(Headquarter.class.getSimpleName(), humanPlayer, new Position(40.5, 51.5));
		entityManager.addNewPCE(Worker.class.getSimpleName(), humanPlayer, new Position(50.5, 50.5));
		entityManager.addNewNPCE(Resource.class.getSimpleName(), new Position(50.5, 41.5));
	}
