...
public class AStar {
	...
	{
		checkInit();
		return AStarCalculator.getClosestUnoccupiedNode(startingPos, towards, occupyingEntityID, world);
	}
	...
	{
		checkInit();
		AStarCalculator pathCalculator = new AStarCalculator(startPos, targetPos,
				heuristicModifier, occupyingEntityID, astarUser, world);
