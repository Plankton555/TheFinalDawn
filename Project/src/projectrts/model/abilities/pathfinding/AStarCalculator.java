...
class AStarCalculator implements Runnable
{
	 ...
	 */
	public AStarCalculator(Position startPos, Position targetPos, int heuristicModifier,
			int occupyingEntityID, AStarUser astarUser, IWorld world)
	{
	...
	public void run() {
		...
		if (endNode.isObstacle(occupyingEntityID))
		{
			...
			endNode = getClosestUnoccupiedNode(targetPos, startPos, occupyingEntityID, world);
		}
	 ...
	 */
	public static AStarNode getClosestUnoccupiedNode(Position startingPos, Position towards, int occupyingEntityID, IWorld world)
	{
