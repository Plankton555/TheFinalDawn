...
public interface IAbilityManager {
	 ...
	 * 
	 * @param entity
	 *            The entity whose abilities you want.
	 ...
	 * 
	 * @param ability
	 *            the name of ability to be used
	 * @param pos
	 *            the position that the ability will be used at
	 */
	void doAbility(String ability, Position pos, IPlayerControlledEntity entity);
	 ...
	 * @param p
	 *            the position to use the ability at
	 * @param owner
	 *            Owner of the entities that will do something.
	 */
	 ...
	 * 
	 * @param pcl
	 *            The PropertyChangeListener you want as listener.
	 */
	void setPropertyChangeLister(PropertyChangeListener pcl);

	/**
	 * If the entity is paired with an ability which class is named like
	 * abilityName, then that ability is aborted.
	 * 
	 * @param abilityName
	 *            The simple name of the ability's class.
	 * @param entity
	 *            The entity the ability is paired with.
	 */
