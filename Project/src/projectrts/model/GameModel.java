...
public class GameModel implements IGame {
	...
	public GameModel() {
		...
		entityManager.addNewPCE(Worker.class.getSimpleName(), humanPlayer, new Position(50, 50));
		...
		entityManager.addNewPCE(Worker.class.getSimpleName(), aiPlayer, new Position(52, 52));
