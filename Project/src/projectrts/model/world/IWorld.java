...
public interface IWorld {
	 ...
	 * 
	 * @param nodeInCenter
	 *            The node in center of the occupied nodes.
	 * @param entitySize
	 *            The size around the center node that will be occupied.
	 * @param entityID
	 *            ID of the entity that occupies.
	 */
	void setNodesOccupied(INode nodeInCenter, float entitySize, int entityID);

	/**
	 * Returns the nodes that would be covered by an object at the provided
	 * position with the provided size.
	 * 
	 * @param centerPos
	 *            Center position.
	 * @param size
