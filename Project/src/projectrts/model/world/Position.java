...
public class Position {
	 ...
	 * 
	 * @return A copy of the position such that
	 *         oldPos.equals(returnedPos)==true.
	 */
	...
	/**
	 * Returns a new position that, from this position, is distance away in the
	 * direction.
	 * 
	 * @param distance
	 ...
	 */
	public static Vector2d getVectorBetween(Position startPos, Position endPos) {
