 ...
 * 
 */
public final class ResourceSpatial extends AbstractSpatial implements
		IEntitySpatial {

	static {
		SpatialFactory.registerSpatial(ResourceSpatial.class.getSimpleName(),
				new ResourceSpatial("ResourceSpatialCreator", new Box()));
	}
	...
	public AbstractSpatial createSpatial(String name, Box box, IEntity entity) {
		...
		Texture texture = TextureManager.getTexture("GoldMine");
